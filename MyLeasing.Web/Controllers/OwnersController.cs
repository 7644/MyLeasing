...
namespace MyLeasing.Web.Controllers
{
    ...
    {
        // los atributos privados deberian empezar con _
        ...
        {
            // para no usar la palabra this se usa este _
        ...
        // el signo de interrogacion significa que puede llegar nulo
        ...
        public async Task<IActionResult> AddProperty(int? id)
        {
            ...
            //FindAsync(id)- busca por la llave primaria
            var owner = await _dataContext.Owners.FindAsync(id);
        ...
        public async Task<IActionResult> EditProperty(int? id)
        {
            ...
            //FindAsync(id)- busca por la llave primaria si la consulta tiene datos relacionados no se podra usar
